...
CREATE TABLE `book` (
  ...
  `user_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `household_book_book_user_id_0552f2d3_fk_user_id` (`user_id`),
  CONSTRAINT `household_book_book_user_id_0552f2d3_fk_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `book_record` (
  ...
  PRIMARY KEY (`id`),
  KEY `household_book_bookr_book_id_d979d202_fk_household` (`book_id`),
  CONSTRAINT `household_book_bookr_book_id_d979d202_fk_household` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
